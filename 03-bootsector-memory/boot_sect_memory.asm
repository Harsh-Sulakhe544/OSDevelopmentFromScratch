...
; attempt 1 ==> attempt 5 , we directly add the 0x7c00
mov al, "5"
int 0x10
mov al, the_secret + 0x7c00

; attempt 5 ==> attempt 6 , we want location 2d plane for x 

mov al, "6"
int 0x10
mov al, the_secret + 0x7c00 
mov al, 2d + 0x7c00 ; due to not availability of 2d lable or variable , system can put any of the weird symbols like =, ! , or an of the special operators 
